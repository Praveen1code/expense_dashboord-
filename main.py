...
st.markdown("""
    <style>
    .metric-card { background-color: #1e293b; padding: 5px; border-radius: 10px; border: 1px solid #334155; }
    div[data-testid="stMetric"] { background-color: #111827; padding: 10px; border-radius: 10px; border: 1px solid #374151; }
    </style>
""", unsafe_allow_html=True)

st.title("📊 Expense Hub")
...
MONTHLY_BUDGET = st.sidebar.number_input("Set Monthly Budget (₹)", min_value=25000.0, value=35000.0, step=100.0)
